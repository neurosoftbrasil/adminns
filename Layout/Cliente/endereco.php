...
<div class="row">
    <div class="col-md-12">
        <button type="button" class="btn btn-default btn-lg" onclick="location.href='/<?=APP_DIR?>cliente/inserir'"><span class='glyphicon glyphicon-chevron-left'></span> Voltar</button>
